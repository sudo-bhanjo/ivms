const languages = [
  ...
  "Portuguese", "Russian", "Italian", "Korean", "Arabic", "Bengali", "Punjabi", 
  "Turkish", "Vietnamese", "Polish", "Ukrainian", "Dutch", "Greek", "Czech", 
  "Swedish", "Hungarian", "Romanian", "Thai", "Finnish", "Norwegian", "Danish", 
  "Hebrew", "Malay", "Serbian", "Indonesian", "Tagalog", "Slovak", "Bulgarian", 
  "Croatian", "Tamil", "Telugu", "Malayalam", "Kannada", "Persian", "Sinhala", 
  "Nepali", "Burmese", "Khmer", "Uzbek", "Azerbaijani", "Lithuanian", "Latvian", 
  "Estonian", "Georgian", "Armenian", "Mongolian", "Macedonian", "Albanian", 
  "Bosnian", "Icelandic", "Luxembourgish", "Irish", "Welsh", "Catalan", "Galician", 
  "Basque", "Haitian Creole", "Afrikaans", "Swahili", "Zulu", "Xhosa", "Igbo", 
  "Yoruba", "Shona", "Amharic", "Somali", "Tigrinya", "Fijian", "Samoan", "Maori", 
  "Hawaiian", "Quechua", "Guarani", "Aymara", "Bislama", "Marshallese", "Tongan", 
  "Kiribati", "Tuvaluan", "Nauruan", "Esperanto", "Interlingua", "Lingala", 
  "Sango", "Tswana", "Setswana", "Tsonga", "Sotho", "Venda", "Luganda", 
  "Kinyarwanda", "Ganda", "Chewa"
];
